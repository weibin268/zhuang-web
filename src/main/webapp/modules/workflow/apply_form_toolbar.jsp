...
<div class="toolbar">
	...
	<a href="javascript:void(0);" id="toolbar_close">
		...
		<div class="button-panel">
			...
			<div class="pic">
				<img src="<%=request.getContextPath()%>/images/workflow/submit.png"
					height="29" width="29" />
			</div>
			<div class="content">
				<span>提交</span>
	...
	</a> <a href="javascript:void(0);" id="toolbar_back">
		<div class="button-panel">

			<div class="pic">
				<img src="<%=request.getContextPath()%>/images/workflow/back.png"
					height="29" width="29" />
			</div>
			<div class="content">
				<span>退回</span>
		...
		<div class="button-panel">
			...
			<div class="pic">
				<img src="<%=request.getContextPath()%>/images/workflow/delete.png"
					height="29" width="29" />
			</div>
			<div class="content">
				<span>删除</span>
...
<div class="return-top">
	<a href="javascript:scroll(0,0)"> <img class="return-top-pic"
		style="height: 25px;"
		src="<%=request.getContextPath()%>/images/workflow/returntop.png" />
